...
class PIDLongitudinalController():
    ...
    # This part of the code implement the PID which you already made in the jupyter notebook. You just need to code the same thing using the local CARLA variable
...
class PIDLateralController():
    ...
    ## This method is where you will implement the lateral PID control. 
    ...
    def _pid_control(self, waypoint, vehicle_transform):
        ...
        # Get the vector vehicle-target_waypoint
        if self._offset != 0:
